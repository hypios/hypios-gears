...
let put_turtle connection namegraph turtle = 
  ...
  let post_parameters = 
    [ 
      Curl.CURLFORM_CONTENT ("data", turtle, Curl.DEFAULT); 
      Curl.CURLFORM_CONTENT ("graph", namegraph, Curl.DEFAULT); 
      Curl.CURLFORM_CONTENT ("mime-type", "application/x-turtle", Curl.DEFAULT); 
    ] in 
